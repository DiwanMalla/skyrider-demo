  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white overflow-hidden selection:bg-blue-500/30">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <FloatingOrb className="top-1/4 left-1/4 w-96 h-96 bg-blue-600/20" delay={0} />
        <FloatingOrb className="bottom-1/4 right-1/4 w-[500px] h-[500px] bg-indigo-600/20" delay={2} />
        <FloatingOrb className="top-1/2 left-1/2 w-64 h-64 bg-emerald-500/20" delay={1} />
      </div>
      ...
      <div className="relative z-10 pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center space-y-6 mb-16">
          <motion.div
            ...
            className="inline-flex items-center justify-center p-4 bg-gradient-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-xl border border-white/10 rounded-3xl mb-4 shadow-2xl shadow-blue-500/20"
          >
            ...
            >
              ...
              <form onSubmit={handleSearch} className="space-y-8 relative z-10">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-blue-200 uppercase tracking-wider ml-1">
                    Select Examination
                  </label>
                  <div className="relative group/input">
                    <select
                      ...
                      className="w-full px-6 py-4 bg-slate-900/50 border border-white/10 rounded-2xl focus:ring-2 focus:ring-blue-500/50 focus:border-blue-400 outline-none transition-all text-white appearance-none cursor-pointer hover:bg-slate-900/70"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative group/input">
                      <Search className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within/input:text-blue-400 transition-colors" />
                      <input
                        type="text"
                        value={symbolNumber}
                        onChange={(e) => setSymbolNumber(e.target.value)}
                        placeholder="e.g. 102030"
                        className="w-full pl-14 pr-6 py-4 bg-slate-900/50 border border-white/10 rounded-2xl focus:ring-2 focus:ring-blue-500/50 focus:border-blue-400 outline-none transition-all text-white placeholder:text-slate-600 hover:bg-slate-900/70"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group/input">
                      <Calendar className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within/input:text-blue-400 transition-colors" />
                      <input
                        type="date"
                        value={dob}
                        onChange={(e) => setDob(e.target.value)}
                        className="w-full pl-14 pr-6 py-4 bg-slate-900/50 border border-white/10 rounded-2xl focus:ring-2 focus:ring-blue-500/50 focus:border-blue-400 outline-none transition-all text-white hover:bg-slate-900/70 [color-scheme:dark]"
                      />
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-3xl shadow-2xl">
              <div className="flex items-center justify-between mb-8">
                ...
                <select
                  ...
                  className="bg-slate-900/50 border border-white/10 text-sm font-medium text-slate-300 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500/50 cursor-pointer hover:bg-slate-900/70 transition"
                >
                ...
                {topStudents.length === 0 ? (
                  ...
                  topStudents.map((student, index) => (
                    <motion.div
                      ...
                      className="group flex items-center gap-4 p-4 bg-slate-900/40 border border-white/5 rounded-2xl hover:bg-slate-800/60 hover:border-blue-500/30 transition-all hover:shadow-lg hover:shadow-blue-500/5 hover:-translate-y-1"
                    >
                      <div
                      ...
                      <div className="text-right">
                        <div className="font-bold text-white bg-white/10 px-2 py-1 rounded-lg inline-block mb-1">
                          {student.gpa}
                        </div>
