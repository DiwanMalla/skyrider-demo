          ...
          <form onSubmit={handleAuth} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all outline-none"
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 to-slate-100 pt-24 pb-12 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-600">View and manage student applications</p>
        </motion.div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-lg border border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all outline-none"
              />
            </div>
            <div className="flex gap-4">
              <select
                ...
                className="px-4 py-3 rounded-lg border border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all outline-none"
              >
        ...
        {loading ? (
          <div className="text-center py-12">
            <div className="inline-block animate-spin rounded-full h-12 w-12 border-4 border-slate-300 border-t-emerald-600"></div>
