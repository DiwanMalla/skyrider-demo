...
import { BookOpen, Users, Trophy, Microscope, Heart, Gamepad2 } from "lucide-react";

export function Banner() {
  const features = [
    { icon: Users, label: "Skilled Instructors", color: "from-blue-500 to-cyan-500" },
    { icon: BookOpen, label: "Online Classes", color: "from-green-500 to-emerald-500" },
    { icon: Trophy, label: "Extra Curriculum", color: "from-purple-500 to-pink-500" },
    { icon: Microscope, label: "Well Equiped Labs", color: "from-orange-500 to-red-500" },
    { icon: Heart, label: "Healthy Cafeteria", color: "from-pink-500 to-rose-500" },
    { icon: Gamepad2, label: "Games & Sports", color: "from-indigo-500 to-blue-500" },
  ];
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            Since the inception, it aims to be the capstone in the streams of Science and Management at +2 level and has been capable in attaining excellent results both at district and national levels.
          </motion.p>
        </motion.div>
