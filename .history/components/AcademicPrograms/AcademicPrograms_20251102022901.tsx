...
export function AcademicPrograms() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const scrollDistance = totalCards * 80; // 80vh per card for smoother progression
      ...
      cards.forEach((card, index) => {
        ...
        const cardStart = (index / totalCards) * scrollDistance;
        const cardEnd = ((index + 1) / totalCards) * scrollDistance;
        ...
        gsap.fromTo(
          ...
          },
          {
            ...
            scrollTrigger: {
              trigger: sectionRef.current,
              start: `top+=${cardStart}vh top`,
              end: `top+=${cardMid}vh top`,
              scrub: 1,
              invalidateOnRefresh: true,
            },
          }
        ...
        gsap.to(card, {
          ...
          scrollTrigger: {
            trigger: sectionRef.current,
            start: `top+=${cardMid}vh top`,
            end: `top+=${cardEnd}vh top`,
            scrub: 1,
            invalidateOnRefresh: true,
          },
        });
        ...
        if (icon) {
          gsap.from(icon, {
            ...
            scrollTrigger: {
              trigger: sectionRef.current,
              start: `top+=${cardStart + 10}vh top`,
              end: `top+=${cardStart + 30}vh top`,
              scrub: 1,
              invalidateOnRefresh: true,
            },
          });
        ...
        if (features.length > 0) {
          gsap.from(features, {
            ...
            scrollTrigger: {
              trigger: sectionRef.current,
              start: `top+=${cardStart + 20}vh top`,
              end: `top+=${cardStart + 40}vh top`,
              scrub: 1,
              invalidateOnRefresh: true,
            },
          });
