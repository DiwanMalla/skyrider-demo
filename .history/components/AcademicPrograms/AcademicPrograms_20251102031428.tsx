    ...
    const ctx = gsap.context(() => {
      ...
      if (scrollContainerRef.current && cardsRef.current.length > 0) {
        ...
        const getScrollAmount = () => {
          ...
          // Scroll enough to show all cards, accounting for the spacer
          const scrollDistance = totalWidth - viewportWidth + 200; // Extra padding
        ...
        const horizontalScroll = gsap.to(scrollContainer, {
          ...
          scrollTrigger: {
            ...
            start: "top top",
            end: () => `+=${Math.abs(getScrollAmount()) * 2}`, // Longer scroll duration
            scrub: 1,
            pin: true,
            anticipatePin: 1,
