    ...
    >
      ...
      <div className="relative">
        ...
        >
          ...
          <div className="w-[calc(50vw-300px)] flex-shrink-0" />
          ...
          {programs.map((program, index) => {
            ...
            return (
              <div
                ...
                className="relative group cursor-pointer flex-shrink-0 w-[450px]"
                    ...
                    <div className="flex-grow">
                      ...
                      <ul className="space-y-3">
                        {program.features.map((feature, featureIndex) => (
                          ...
                          >
                            <div
                              className={`w-2 h-2 rounded-full bg-linear-to-r ${program.color} mt-2 flex-shrink-0`}
                            />
          ...
          <div className="flex-shrink-0 w-[500px] h-[600px]">
