            ...
            return (
              ...
              >
                ...
                <div className="relative p-8 rounded-3xl bg-white/90 backdrop-blur-xl border border-slate-300/50 shadow-xl overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <ul className="space-y-3">
                      {program.features.map((feature, featureIndex) => (
                        ...
                        >
                          <div
                            className={`feature-bullet mt-1 w-2 h-2 rounded-full bg-linear-to-r ${program.color} shadow-lg flex-shrink-0`}
                          />
                  ...
                  <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-linear-to-tr from-purple-300/30 to-pink-300/30 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 animate-pulse" style={{ animationDelay: '0.5s' }} />
                </div>
              </div>
            );
          })}
