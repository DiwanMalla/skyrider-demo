    ...
    const ctx = gsap.context(() => {
      ...
      gsap.to(cardsContainer, {
        ...
        scrollTrigger: {
          ...
          scrub: 1,
          onUpdate: (self) => {
            console.log("Horizontal progress:", self.progress, "xPercent:", -(totalCards - 1) * 25 * self.progress);
          },
        },
      });
        ...
        if (features.length > 0) {
          features.forEach((feature, fIndex) => {
            gsap.from(feature, {
              ...
              scrollTrigger: {
                trigger: sectionRef.current,
                start: `top+=${cardProgress * scrollDistance + 20 + fIndex * 2}vh top`,
                end: `top+=${cardProgress * scrollDistance + 40 + fIndex * 2}vh top`,
                scrub: 1,
              },
            });
          });
          ...
          >
            {programs.map((program, index) => {
              ...
              return (
                <div
                  key={index}
                  className="h-full flex items-center justify-center px-6 shrink-0"
                  style={{ minWidth: "100%" }}
                >
                  <div
                    ref={(el) => {
