              ...
              >
                ...
                <div className="relative h-[480px] sm:h-[540px] md:h-[560px] lg:h-[550px] rounded-2xl sm:rounded-3xl bg-white border-2 border-slate-200 shadow-xl overflow-hidden">
                  ...
                  <div className="relative z-10 p-4 sm:p-5 md:p-6 lg:p-8 h-full flex flex-col">
                    ...
                    {/* Features */}
                    <div className="grow">
                      <h4 className="font-semibold text-slate-900 mb-1.5 sm:mb-2 md:mb-3 lg:mb-4 text-xs sm:text-sm md:text-base lg:text-lg">
                        Key Features:
                      </h4>
                      <ul className="space-y-1 sm:space-y-1.5 md:space-y-2 lg:space-y-3">
                        {program.features.map((feature, featureIndex) => (
                          <li
                            key={featureIndex}
                            className="flex items-start gap-1.5 sm:gap-2 text-slate-700"
                          >
                            <div
                              className={`w-1 h-1 sm:w-1.5 sm:h-1.5 md:w-2 md:h-2 rounded-full bg-linear-to-r ${program.color} mt-1 shrink-0`}
                            />
                            <span className="text-[9px] sm:text-[10px] md:text-xs lg:text-sm leading-relaxed">
                              {feature}
                            </span>
                          </li>
                        ))}
