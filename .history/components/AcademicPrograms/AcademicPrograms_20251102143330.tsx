    ...
    >
      ...
      <div className="relative">
        ...
        >
          ...
          <div className="w-5 sm:w-[50px] md:w-[calc(50vw-300px)] shrink-0" />
                ...
                <div className="relative h-[550px] sm:h-[580px] md:h-[600px] lg:h-[550px] rounded-3xl bg-white border-2 border-slate-200 shadow-xl overflow-hidden">
                  ...
                  <div className="relative z-10 p-6 sm:p-7 md:p-8 h-full flex flex-col">
                    ...
                    <div className="mb-4 sm:mb-5 md:mb-6">
                      <div
                        className={`program-icon w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20 rounded-2xl sm:rounded-3xl bg-linear-to-br ${program.color} flex items-center justify-center shadow-2xl`}
                      >
                    ...
                    {/* Level badge */}
                    <div className="inline-flex self-start px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-emerald-100 text-emerald-700 text-xs sm:text-sm font-bold uppercase tracking-wide mb-3 sm:mb-4">
                      {program.level}
                    </div>

                    {/* Title */}
                    <h3 className="text-2xl sm:text-2xl md:text-3xl font-bold text-slate-900 mb-3 sm:mb-4">
                      {program.title}
                    </h3>

                    {/* Description */}
                    <p className="text-slate-600 text-sm sm:text-base leading-relaxed mb-4 sm:mb-5 md:mb-6">
                      {program.description}
                    </p>
                    ...
                    <div className="grow">
                      ...
                      <ul className="space-y-2 sm:space-y-3">
                        {program.features.map((feature, featureIndex) => (
                          ...
                          >
                            <div
                              className={`w-2 h-2 rounded-full bg-linear-to-r ${program.color} mt-1.5 sm:mt-2 shrink-0`}
                            />
