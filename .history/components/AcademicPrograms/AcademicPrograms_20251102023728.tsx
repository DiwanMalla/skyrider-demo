...
export function AcademicPrograms() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Create the main ScrollTrigger that pins the section
      ...
      gsap.to(cardsContainer, {
        x: () => {
          // Move left by the width of all cards except the first one
          const containerWidth = cardsContainer.offsetWidth;
          return -(containerWidth * (totalCards - 1) / totalCards);
        },
        ease: "none",
        scrollTrigger: {
          trigger: section,
      ...
      cards.forEach((card, index) => {
        ...
        const nextProgress = (index + 1) / totalCards;
        ...
        gsap.fromTo(
          ...
          { opacity: 0, scale: 0.9 },
          {
            ...
            scrollTrigger: {
              trigger: section,
              start: `top+=${progress * scrollLength}vh top`,
              end: `top+=${progress * scrollLength + 25}vh top`,
              scrub: 1,
            },
          }
        );

        // Card fade out (except last one)
        if (index < totalCards - 1) {
          gsap.to(card, {
            ...
            scrollTrigger: {
              trigger: section,
              start: `top+=${nextProgress * scrollLength - 25}vh top`,
              end: `top+=${nextProgress * scrollLength}vh top`,
              scrub: 1,
            },
          });
        }
        ...
        if (icon) {
          gsap.fromTo(
            ...
            { rotation: 360, scale: 0 },
            {
              ...
              scrollTrigger: {
                trigger: section,
                start: `top+=${progress * scrollLength + 10}vh top`,
                end: `top+=${progress * scrollLength + 35}vh top`,
                scrub: 1,
              },
            }
          );
        ...
        features.forEach((feature, fIndex) => {
          gsap.fromTo(
            ...
            { x: -20, opacity: 0 },
            {
              ...
              scrollTrigger: {
                trigger: section,
                start: `top+=${progress * scrollLength + 20 + fIndex * 3}vh top`,
                end: `top+=${progress * scrollLength + 35 + fIndex * 3}vh top`,
                scrub: 1,
              },
            }
          );
  ...
  return (
    ...
    >
      <div className="h-screen grid grid-cols-1 lg:grid-cols-12 gap-8 px-4 sm:px-6 lg:px-8">
        {/* Left Column - Fixed Content */}
        <div className="lg:col-span-5 flex flex-col justify-center py-20 lg:py-0 relative z-20">
        ...
        <div
          ref={containerRef}
          className="lg:col-span-7 relative flex items-center overflow-hidden"
        >
          <div
