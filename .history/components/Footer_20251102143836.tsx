          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-linear-to-br from-emerald-500 to-sky-500 rounded-xl sm:rounded-2xl flex items-center justify-center">
                  <GraduationCap className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                </div>
                <h3 className="font-bold text-lg sm:text-xl">Skyrider High School</h3>
              </div>
              ...
              <div className="flex gap-3 sm:gap-4">
                <a
                  href="#"
                  className="w-8 h-8 sm:w-10 sm:h-10 bg-slate-800 rounded-full flex items-center justify-center hover:bg-emerald-600 transition-colors duration-300"
                >
                  <Facebook className="w-4 h-4 sm:w-5 sm:h-5" />
                </a>
                <a
                  href="#"
                  className="w-8 h-8 sm:w-10 sm:h-10 bg-slate-800 rounded-full flex items-center justify-center hover:bg-sky-500 transition-colors duration-300"
                >
                  <Instagram className="w-4 h-4 sm:w-5 sm:h-5" />
                </a>
                <a
                  href="#"
                  className="w-8 h-8 sm:w-10 sm:h-10 bg-slate-800 rounded-full flex items-center justify-center hover:bg-blue-500 transition-colors duration-300"
                >
                  <Twitter className="w-4 h-4 sm:w-5 sm:h-5" />
                </a>
                <a
                  href="#"
                  className="w-8 h-8 sm:w-10 sm:h-10 bg-slate-800 rounded-full flex items-center justify-center hover:bg-red-500 transition-colors duration-300"
                >
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <p className="text-slate-400 text-xs sm:text-sm">+977-056562782</p>
                </div>

                <div className="flex items-center gap-2 sm:gap-3">
                  <Mail className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400 shrink-0" />
                  <p className="text-slate-400 text-xs sm:text-sm">info@skyrider.edu.np</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white text-xs sm:text-sm focus:outline-none focus:border-emerald-400"
                  />
                  <button className="px-3 sm:px-4 py-2 bg-linear-to-r from-emerald-500 to-sky-500 rounded-lg text-white text-xs sm:text-sm font-medium hover:from-emerald-600 hover:to-sky-600 transition-all duration-300 whitespace-nowrap">
                    Subscribe
                  </button>
                </div>
              </div>
        ...
        <div className="border-t border-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
              ...
              <div className="flex flex-wrap justify-center sm:justify-end items-center gap-3 sm:gap-6 text-xs sm:text-sm">
                <Link
                  href="/privacy"
