...
import { Flask, BookOpen, Calendar, GraduationCap } from "lucide-react";
          ...
          {offerings.map((offering, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -10 }}
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${offering.bgGradient} rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl`} />
