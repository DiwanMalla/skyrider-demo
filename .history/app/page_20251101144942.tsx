    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
      ...
      <div className="relative">
        ...
        <section className="relative w-full h-[70vh] md:h-[80vh] overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-slate-900/60 via-slate-900/40 to-slate-900/50" />
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <motion.h1
                ref={titleRef}
                className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-white leading-tight mb-6 drop-shadow-2xl"
              >
                Welcome to
                <br />
                <span className="text-emerald-400">Skyrider High School</span>
              </motion.h1>

              <motion.p
                ref={subtitleRef}
                className="text-lg sm:text-xl md:text-2xl text-white/95 mb-8 max-w-3xl mx-auto drop-shadow-lg font-medium"
              >
                Empowering minds, shaping futures — where excellence meets opportunity
              </motion.p>
