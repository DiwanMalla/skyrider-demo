  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-emerald-50 via-sky-50 to-indigo-50 opacity-50" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 via-sky-600 to-indigo-600">
              Welcome to SKYRIDER
            </h1>
            <p className="text-slate-600 text-lg md:text-xl max-w-4xl mx-auto leading-relaxed">
              Since the inception, it aims to be the capstone in the streams of Science and 
              Management at +2 level and has been capable in attaining excellent results both 
              at district and national levels by holding top ranks with other remarkable positions, 
              also spreading its fumes abroad.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-6">
                Sky Rider is the need of time and we are keen to transform the career of 
                adolescent learners in order to make them able to cope with the demand of 
                modern global standard.
              </p>
              <p className="text-slate-600 text-lg leading-relaxed">
                It trains students to be practical, cumulative and behavioral and thus making 
                them self-responsive, determinant and obligatory.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-600 text-lg max-w-2xl mx-auto">
              We provide world-class facilities to ensure holistic development of our students
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-emerald-500 to-sky-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {instructors.map((instructor, index) => (
              ...
              >
                ...
                <p className="text-emerald-600 font-medium">{instructor.position}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">Ratnagar-13, Chitwan, Nepal</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-4 rounded-lg bg-gradient-to-r from-emerald-600 to-sky-600 text-white font-semibold hover:from-emerald-700 hover:to-sky-700 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
                  Send Message
                </button>
            ...
            >
              <div className="w-full h-full rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3533.0887344656984!2d84.42863107548422!3d27.66298797619558!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3994fb4e9a0e7e99%3A0x1234567890abcdef!2sRatnagar%2013%2C%20Chitwan!5e0!3m2!1sen!2snp!4v1234567890123!5m2!1sen!2snp"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
