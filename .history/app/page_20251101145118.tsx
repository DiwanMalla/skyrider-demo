    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
      ...
      <div className="relative">
        ...
        <section className="relative w-full h-[70vh] md:h-[80vh] overflow-hidden">
          ...
          <div className="absolute inset-0 z-10 bg-gradient-to-b from-slate-900/60 via-slate-900/40 to-slate-900/50" />
          ...
          <div className="absolute inset-0 z-20 flex items-center justify-center">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              >
                Welcome to
                <br />
                <span className="text-emerald-400 drop-shadow-lg">Skyrider High School</span>
              </motion.h1>

              <motion.p
                ref={subtitleRef}
                className="text-lg sm:text-xl md:text-2xl text-white mb-8 max-w-3xl mx-auto font-medium"
                style={{
