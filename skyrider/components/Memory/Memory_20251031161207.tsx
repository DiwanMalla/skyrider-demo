...
export const Memory = ({
  ...
  // GSAP animations for hover and interactive effects
  const handleMouseEnter = () => {
    ...
    // Animate left border on hover with GSAP
  ...
  // GSAP mount animation (stagger effect)
  useEffect(() => {
  ...
  return (
    ...
    >
      {/* Left accent bar with GSAP animation */}
      <div
        ref={borderRef}
        className={`absolute left-0 top-0 w-1 h-0 ${borderClass} origin-top`}
